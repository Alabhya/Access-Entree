...
public class PlayerInteractorBase : MonoBehaviour
{
    ...
    #endregion
    #region Singleton
    private static PlayerInteractorBase _instance;

    public static PlayerInteractorBase Instance { get { return _instance; } }
    #endregion
    ...
    {
        Debug.Log("Doing Base Interaction");
    }
    #endregion
